 ...
 *
 */
class model_settings2022 extends model_base
{

	public function __construct()
	{
		parent::__construct('settings2022');
	}
	...
	public static function get_all_entries()
	{
		...
		return data_entry::get_all('settings2022', __CLASS__);
	}
	...
	public static function delete_entry_by_id($settings_id)
	{
		...
		$sql = "
			DELETE FROM `settings2022` WHERE `settings2022_id` = $settings_id;
		";
		return $db->query($sql);
	}
