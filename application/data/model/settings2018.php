 ...
 *
 */
class model_settings2018 extends model_base
{

	public function __construct()
	{
		parent::__construct('settings2018');
	}
	...
	public static function get_all_entries()
	{
		...
		return data_entry::get_all('settings2018', __CLASS__);
	}
	...
	public static function delete_entry_by_id($settings_id)
	{
		...
		$sql = "
			DELETE FROM `settings2018` WHERE `settings2018_id` = $settings_id;
		";
		return $db->query($sql);
	}
