 ...
 *
 */
class model_settings2019 extends model_base
{

	public function __construct()
	{
		parent::__construct('settings2019');
	}
	...
	public static function get_all_entries()
	{
		...
		return data_entry::get_all('settings2019', __CLASS__);
	}
	...
	public static function delete_entry_by_id($settings_id)
	{
		...
		$sql = "
			DELETE FROM `settings2019` WHERE `settings2019_id` = $settings_id;
		";
		return $db->query($sql);
	}
