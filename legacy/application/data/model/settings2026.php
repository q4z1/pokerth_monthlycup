 ...
 *
 */
class model_settings2026 extends model_base
{

	public function __construct()
	{
		parent::__construct('settings2026');
	}
	...
	public static function get_all_entries()
	{
		...
		return data_entry::get_all('settings2026', __CLASS__);
	}
	...
	public static function delete_entry_by_id($settings_id)
	{
		...
		$sql = "
			DELETE FROM `settings2026` WHERE `settings2026_id` = $settings_id;
		";
		return $db->query($sql);
	}
